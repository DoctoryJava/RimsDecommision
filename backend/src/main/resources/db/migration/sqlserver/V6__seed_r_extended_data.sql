...
('sd-001','sys-001','POSTGRESQL','prod-cop-db.internal','cop_main','kv://cop-db-conn','h-9f2e41a0',N'Customer Order Platform 主库'),
('sd-002','sys-002','ORACLE','legacy-hr-db.internal','HRPROD','kv://hr-db-conn','h-c12b73fe',N'Legacy HR 生产库'),
('sd-003','sys-003','SQLSERVER','fin-dw.internal','FIN_DW','kv://fin-db-conn','h-5d81bc92',N'财务报表数仓'),
('sd-004','sys-005','MYSQL','inv-trk-db.internal','inventory','kv://inv-db-conn','h-0a3f67cd',N'库存跟踪库'),
('sd-005','sys-006','MONGODB','mcm-mongo.internal','campaigns','kv://mcm-db-conn','h-e8b4051d',N'营销活动库');
...
('us-001','sys-001','AZURE_BLOB','https://src.blob.core.windows.net/cop-invoices','/mnt/cop/invoices','*.pdf','regex:INV-YYYYMMDD-*.pdf',N'订单发票附件'),
('us-002','sys-004','FILE_SHARE','//legacy/mobilepush/attachments','/mnt/mpg/attachments','*.png','lastModifiedDate',N'推送网关静态资源'),
('us-003','sys-006','MINIO','s3://mcm-assets/campaigns','/mnt/mcm/assets','*.json','lastModifiedDate',N'营销素材');
...
('rp-001','RET_ARCHIVE_7Y',N'通用归档保留 7 年',N'退役系统归档数据默认保留 7 年',2557,'SYNC_COMPLETED','2026-01-01 00:00:00'),
('rp-002','RET_FINANCE_10Y',N'财务合规保留 10 年',N'财务数据按监管要求保留 10 年',3652,'SYNC_COMPLETED','2026-01-01 00:00:00'),
('rp-003','RET_HR_5Y',N'HR 数据保留 5 年',N'人力资源数据保留 5 年',1826,'SYNC_COMPLETED','2026-01-01 00:00:00');
...
('lh-001','ra-003','HOLD','2026-07-30 09:00:00',NULL,N'疑似劳动争议诉讼，冻结 HR 数据','u-003','2026-07-30 09:05:00'),
('lh-002','ra-004','HOLD','2026-08-01 10:00:00',NULL,N'审计取证，冻结订单数据','u-003','2026-08-01 10:02:00');
